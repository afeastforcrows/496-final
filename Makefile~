#
# GNU Makefile for the generic GLFW project
#
# Michael Shafae
...
TARGET = picking
# C++ Files
CXXFILES =   picking_glfw.cpp PlyModel.cpp transformations.cpp BBox.cpp SceneObj.cpp SceneGraph.cpp
CFILES =  
# Headers
HEADERS =  BBox.h SceneObj.h SceneGraph.h
